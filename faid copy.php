...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Bilbo+Swash+Caps&amp;display=swap">
    ...
    <style>
        .faid {
            box-shadow: 0px 0px 2px 2px rgba(68,25,103,0.26);
            margin: 10px;
            margin-top: 10px;
            border-radius: 5px;
            margin-bottom: 0px;
...
<body>
   ...
   <?php
    ...
    <section class="article-list">
        <div class="container">
            <div class="intro">
                <h2 class="text-center" style="color: #441967;">First Aid Instructions</h2>
    ...
    <nav class="navbar navbar-light navbar-expand-md fixed-bottom" style="background: #ffffff;margin-top: 0px;margin-bottom: 0px;">
        <div class="container-fluid"><a class="navbar-brand" href="index.html" style="font-family: Actor, sans-serif;color: rgb(68,25,103);font-weight: bold;">Vaid</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1" style="border-style: none;"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse d-xl-flex justify-content-xl-end" id="navcol-1">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link" href="about.html" style="font-family: Actor, sans-serif;color: rgb(68,25,103);">About</a></li>
                    <li class="nav-item"><a class="nav-link" data-bss-hover-animate="flash" href="faid.html" style="font-family: Actor, sans-serif;color: rgb(68,25,103);">First Aid Instructions</a></li>
                    <li class="nav-item dropup"><a class="nav-link" aria-expanded="false" data-toggle="dropdown" data-bss-hover-animate="flash" href="#" style="color: rgb(68,25,103);">Emergency Contacts</a>
                        <div class="dropdown-menu" style="background: #441967;"><a class="dropdown-item text-center" href="#" style="color: rgb(255,255,255);">Ambulance</a><a class="dropdown-item text-center" href="#" style="color: rgb(255,255,255);">Police</a><a class="dropdown-item text-center" href="#" style="color: rgb(255,255,255);">Fire Brigade</a></div>
                    </li>
                </ul>
            </div>
        </div>
